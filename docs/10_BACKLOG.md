...
| 7 | TOOL-002 | P2 | `VERIFY` | JSON Viewer megvalósítva (teljesen kliens-oldali, backend nélkül), helyi böngésző-teszttel igazolva, éles deploy hátravan | PLAT-001 (kész) |
