...
| 2 | MON-001 | P1 | `VERIFY` | Google AdSense: fiók + `ads.txt` kész, hirdetéskód (`adsbygoogle.js`, `ca-pub-2290062414680227`) élesben fut mind a 18 HU/EN oldalon (ADR-017), GDPR consent-üzenet (Funding Choices, "Európai szabályozások") közzétéve HU+EN nyelven, elutasítás-gombbal — élesben ellenőrizve. A Google korábban "megjelenítői tartalom nélküli képernyőn" irányelvsértést jelzett (a hiányzó hirdetéskód miatt) — a javítás után a felhasználó megkérte az újra-felülvizsgálatot; ez már nem rajtunk múlik, napok kérdése lehet. | landing oldal + adatvédelmi tájékoztató (kész) |
